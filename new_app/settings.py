...
SECRET_KEY = env.str("DJANGO_SECRET", 'django-insecure-g^6-t9)*_)$*c&==8-mlv#!%o-#+j5#eh&$*tcr5_0d%fwvrbq')
...
POSTGRES_URI = env.db("DATABASE_URL")
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql_psycopg2",
        "NAME": POSTGRES_URI["NAME"],
        "USER": POSTGRES_URI["USER"],
        "PASSWORD": POSTGRES_URI["PASSWORD"],
        "HOST": POSTGRES_URI["HOST"],
